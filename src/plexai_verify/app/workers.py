...
from plexai_verify.app.audit import duplicate_groups, quality_assessment
from plexai_verify.app.database import (
...
from plexai_verify.app.ffprobe import analyze_video
from plexai_verify.app.image_extractor import build_video_dna,build_visual_hash,extract_frames
from plexai_verify.app.ollama_ai import identify_movie, identify_movie_autopilot
from plexai_verify.app.scanner import scan_movies
from plexai_verify.app.express import express_decision
from plexai_verify.app.local_compare import compare_with_local_ai
from plexai_verify.app.media_support import classify_processing_error
    ...
    def run(self):
        ...
        try:
            ...
            if (
                ...
                from plexai_verify.app.database import get_movie
...
from plexai_verify.app.tmdb_client import compare_movie
from plexai_verify.app.renamer import rename_movie
